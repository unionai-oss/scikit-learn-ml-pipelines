...
from tasks.predict import batch_knn_predict, actor_model_predict
from flytekit.core.artifact import Artifact
from typing_extensions import Annotated
from sklearn.neighbors import KNeighborsClassifier
from typing import List
from flytekit import task, workflow, Resources, ImageSpec, FlyteFile
...
def train_iris_classification(n_neighbors: int=3, 
                              pred_data: List[List[float]]=[[1.2, 2.1, 3.3, 4.0]]) -> FlyteFile:
